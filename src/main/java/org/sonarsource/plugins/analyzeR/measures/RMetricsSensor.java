...
import org.sonarsource.plugins.analyzeR.RLanguageDefinition;
import org.sonarsource.plugins.analyzeR.analyzeR;
...
public class RMetricsSensor implements Sensor {
    ...
    public void execute(SensorContext sensorContext) {
        ...
        // Reading metrics
        Optional<String> rscriptOutput = sensorContext.config().get(analyzeR.PROPERTY_METRICS_FILE);
