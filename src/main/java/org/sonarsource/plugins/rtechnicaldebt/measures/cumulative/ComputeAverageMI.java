...
/**
 * Computes Cumulative Martin's Instability Measure
 */
public class ComputeAverageMI implements MeasureComputer {

  /**
   * Initializes the MI Metric for Project-Wide Metrics
  ...
  /**
   * Computes the cumulative MI metric.
  ...
  public void compute(MeasureComputerContext context) {
    ...
    if (context.getComponent().getType() != Component.Type.FILE) {
      ...
      context.addMeasure(MARTINS_INSTABILITY.key(), (float) average);
    }
  }
}
